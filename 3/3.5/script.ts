...
container.append(...all.map((c: string) => {
...
let selections: { first?: HTMLDivElement, second?: HTMLDivElement } = {
    first: undefined,
    second: undefined
};

const elements = [].slice.call(container.children) as HTMLDivElement[];
let blocked = false;
